...
public class MariaDbProcedureServiceImpl implements DataBaseProcedureService {
	...
	public String selectArguments(String owner, String objectName) {
		return "select PARAMETER_NAME as ARGUMENT_NAME, DATA_TYPE, PARAMETER_MODE as IN_OUT from information_schema.PARAMETERS t where t.ROUTINE_TYPE = 'PROCEDURE' and t.SPECIFIC_NAME = '"
				+ objectName + "' ORDER BY ORDINAL_POSITION";
	}
