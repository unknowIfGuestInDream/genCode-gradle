...
public class NoDataBaseInfoServiceImpl implements DataBaseInfoService {
	...
	public void initDataBaseInfoList() {
		...
		map.put("URL",
				"jdbc:mysql://127.0.0.1:3306/mydb?useUnicode=true&characterEncoding=utf8&useSSL=true&serverTimezone=Asia/Shanghai&autoReconnect=true&useOldAliasMetadataBehavior=true");
