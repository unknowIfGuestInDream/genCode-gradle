...
public class ListToTreeTest {
	...
	public void listToTree() throws JsonProcessingException {
		...
		init(list);
		List<Map<String, Object>> children = ListToTreeUtil.listToTree(list, (m) -> "-1".equals(m.get("PID")), "ID",
				"PID", true);
		List<Map<String, Object>> children1 = ListToTreeUtil.listToTree(list, (m) -> "-1".equals(m.get("PID")),
				(m) -> m.get("ID"), (n) -> n.get("PID"), true);
