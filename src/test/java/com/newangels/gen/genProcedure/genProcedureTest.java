...
public class genProcedureTest {
	...
	public void genProcedureEamNew() {
		...
		Map<String, Object> result = genProcedureModel.genCode("code", "cn.newangels.gen", "budgetuser",
				procedureNameList, "admin", NameConventFactory.getNameConvent(NameConventType.fromCode("2")),
